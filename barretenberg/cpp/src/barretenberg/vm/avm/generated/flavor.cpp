...
AvmFlavor::AllConstRefValues::AllConstRefValues(
    ...
    , range_check_l2_gas_hi_counts(il[646])
    , range_check_l2_gas_lo_counts(il[647])
    , range_check_da_gas_hi_counts(il[648])
    , range_check_da_gas_lo_counts(il[649])
    , lookup_cd_value_counts(il[650])
    , lookup_ret_value_counts(il[651])
    , kernel_output_lookup_counts(il[652])
    , lookup_into_kernel_counts(il[653])
    , incl_main_tag_err_counts(il[654])
    , incl_mem_tag_err_counts(il[655])
    , lookup_mem_rng_chk_lo_counts(il[656])
    , lookup_mem_rng_chk_mid_counts(il[657])
    , lookup_mem_rng_chk_hi_counts(il[658])
    , lookup_pow_2_0_counts(il[659])
    , lookup_pow_2_1_counts(il[660])
    , lookup_u8_0_counts(il[661])
    , lookup_u8_1_counts(il[662])
    , lookup_u16_0_counts(il[663])
    , lookup_u16_1_counts(il[664])
    , lookup_u16_2_counts(il[665])
    , lookup_u16_3_counts(il[666])
    , lookup_u16_4_counts(il[667])
    , lookup_u16_5_counts(il[668])
    , lookup_u16_6_counts(il[669])
    , lookup_u16_7_counts(il[670])
    , lookup_u16_8_counts(il[671])
    , lookup_u16_9_counts(il[672])
    , lookup_u16_10_counts(il[673])
    , lookup_u16_11_counts(il[674])
    , lookup_u16_12_counts(il[675])
    , lookup_u16_13_counts(il[676])
    , lookup_u16_14_counts(il[677])
    , lookup_div_u16_0_counts(il[678])
    , lookup_div_u16_1_counts(il[679])
    , lookup_div_u16_2_counts(il[680])
    , lookup_div_u16_3_counts(il[681])
    , lookup_div_u16_4_counts(il[682])
    , lookup_div_u16_5_counts(il[683])
    , lookup_div_u16_6_counts(il[684])
    , lookup_div_u16_7_counts(il[685])
    ...
    , lookup_byte_lengths_inv(il[719])
    , lookup_byte_operations_inv(il[720])
    , lookup_opcode_gas_inv(il[721])
    , range_check_l2_gas_hi_inv(il[722])
    , range_check_l2_gas_lo_inv(il[723])
    , range_check_da_gas_hi_inv(il[724])
    , range_check_da_gas_lo_inv(il[725])
    , lookup_cd_value_inv(il[726])
    , lookup_ret_value_inv(il[727])
    , kernel_output_lookup_inv(il[728])
    , lookup_into_kernel_inv(il[729])
    , incl_main_tag_err_inv(il[730])
    , incl_mem_tag_err_inv(il[731])
    , lookup_mem_rng_chk_lo_inv(il[732])
    , lookup_mem_rng_chk_mid_inv(il[733])
    , lookup_mem_rng_chk_hi_inv(il[734])
    , lookup_pow_2_0_inv(il[735])
    , lookup_pow_2_1_inv(il[736])
    , lookup_u8_0_inv(il[737])
    , lookup_u8_1_inv(il[738])
    , lookup_u16_0_inv(il[739])
    , lookup_u16_1_inv(il[740])
    , lookup_u16_2_inv(il[741])
    , lookup_u16_3_inv(il[742])
    , lookup_u16_4_inv(il[743])
    , lookup_u16_5_inv(il[744])
    , lookup_u16_6_inv(il[745])
    , lookup_u16_7_inv(il[746])
    , lookup_u16_8_inv(il[747])
    , lookup_u16_9_inv(il[748])
    , lookup_u16_10_inv(il[749])
    , lookup_u16_11_inv(il[750])
    , lookup_u16_12_inv(il[751])
    , lookup_u16_13_inv(il[752])
    , lookup_u16_14_inv(il[753])
    , lookup_div_u16_0_inv(il[754])
    , lookup_div_u16_1_inv(il[755])
    , lookup_div_u16_2_inv(il[756])
    , lookup_div_u16_3_inv(il[757])
    , lookup_div_u16_4_inv(il[758])
    , lookup_div_u16_5_inv(il[759])
    , lookup_div_u16_6_inv(il[760])
    , lookup_div_u16_7_inv(il[761])
    ...
    , kernel_emit_l2_to_l1_msg_write_offset_shift(il[806])
    , kernel_emit_note_hash_write_offset_shift(il[807])
    , kernel_emit_nullifier_write_offset_shift(il[808])
    , kernel_emit_unencrypted_log_write_offset_shift(il[809])
    , kernel_l1_to_l2_msg_exists_write_offset_shift(il[810])
    , kernel_note_hash_exist_write_offset_shift(il[811])
    , kernel_nullifier_exists_write_offset_shift(il[812])
    , kernel_nullifier_non_exists_write_offset_shift(il[813])
    , kernel_side_effect_counter_shift(il[814])
    , kernel_sload_write_offset_shift(il[815])
    , kernel_sstore_write_offset_shift(il[816])
    , main_da_gas_remaining_shift(il[817])
    , main_internal_return_ptr_shift(il[818])
    , main_l2_gas_remaining_shift(il[819])
    , main_pc_shift(il[820])
    , main_sel_execution_row_shift(il[821])
